...
###
### PROS:
### inheritance / lower repetition
### built in methods and views / redundancy / common use cases
### 
### HOW THEY WORK:
### we query the database and pass some text data
### and it creates a view from it for us
###
#### MIXIN - class that is designed to provide certain (one) functionallity :
###
### list mixin - shows all the information - GET
### retrieve mixin - can show specific information (fields) - GET
### update mixin - PUT
### delete mixin - DELETE
###
...
class UserRUD(mixins.RetrieveModelMixin,
    ...
    def get(self, request, *args, **kwargs):
        return self.retrieve(request, *args, **kwargs) # self.retrieve this comes from retrieve mixin
...
### this could go in UserRUD, because getting repetitive // not sure (permissons)
